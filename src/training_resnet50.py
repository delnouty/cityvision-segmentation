...
# ============================================================
# 2. RESNET50 ENCODER + U-NET DECODER
#
#  ResNet50 uses Bottleneck blocks, so feature maps are 4× wider
#  than ResNet18/34. Feature map sizes (input 512x1024):
...
class ResNet50UNet(nn.Module):
    def __init__(self, num_classes=NUM_CLASSES, pretrained=True):
        ...
        self.dec4 = DoubleConv(512 + 1024, 512)   # cat layer3 (1024ch)

        self.up3  = nn.ConvTranspose2d(512, 256, 2, stride=2)
        self.dec3 = DoubleConv(256 + 512, 256)    # cat layer2 (512ch)

        self.up2  = nn.ConvTranspose2d(256, 128, 2, stride=2)
        self.dec2 = DoubleConv(128 + 256, 128)    # cat layer1 (256ch)
...
def main():
    ...
    checkpoint_path = os.path.join(project_root, "backend", "model", "resnet50_best.pth")
    ...
    with mlflow.start_run(run_name="model_train_resnet50"):
        mlflow.log_params({
            "epochs":       epochs,
            "patience":     patience,
