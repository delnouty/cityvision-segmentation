...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--arch", required=True, choices=sorted(ARCH_PRESETS),
    ...
    p.add_argument("--encoder-lr-mult", type=float, default=None, dest="encoder_lr_mult")
    p.add_argument("--patience", type=int, default=None,
                   help="Early-stopping patience (0 disables).")
    p.add_argument("--dropout", type=float, default=None)
    p.add_argument("--img-size", type=_parse_img_size, default=None, dest="img_size",
    ...
    pre.add_argument("--pretrained", action="store_true", default=None,
                     help="Use ImageNet-pretrained encoder weights.")
    pre.add_argument("--no-pretrained", action="store_false", default=None,
                     dest="pretrained", help="Train the encoder from scratch.")

    bal = p.add_mutually_exclusive_group()
    bal.add_argument("--balanced", action="store_true", default=None,
                     help="Use the class-balanced WeightedRandomSampler.")
    bal.add_argument("--no-balanced", action="store_false", default=None,
                     dest="balanced", help="Plain random shuffling instead.")

    p.add_argument("--checkpoint-name", default=None, dest="checkpoint_name",
    ...
    p.add_argument("--registered-model-name", default=None, dest="registered_model_name",
